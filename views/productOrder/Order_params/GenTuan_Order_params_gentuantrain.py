...
class GenTuan_Order_params_gentuantrain(Gentuan_BOH_train):
    #获取行程1ID
                    ...
                    "journey": [
                        {
                            ...
                            "resourceTrainTicket": [
                                ...
                                {
                                    "resourceId": '''+self.gentuan_get_resourceId2()+''',
                                    "resourceName": "",
    ...
    def GenTuan_Order_params_gentuantrain(self):
        GenTuan_Order_params_gentuantrain = "{" + str(self.GenTuan_Params_channelData()) + "," + str(self.GenTuan_Params_order()) + "," + str(self.GenTuan_Params_subOrders()) + "}"

        return GenTuan_Order_params_gentuantrain


if __name__ == '__main__':

    genp = GenTuan_Order_params_gentuantrain()
    params=genp.GenTuan_Order_params_gentuantrain()
    print (params)
