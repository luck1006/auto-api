...
class Zijia_BOH(interface_boh.interface_boh):
    ...
    def getDetailResources(self):
        ...
        #将参数组装成字典
        rsp_dict = dict(journeyId1=journeyId1, journeyId2=journeyId2,resId1=resId1,resId2=resId2,resType=resType,resSubType=resSubType)
        return rsp_dict
