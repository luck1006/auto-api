...
#设置蓝图
zizhu_ziyuanzuhe = Blueprint('zizhu_ziyuanzuhe', __name__)
@zizhu_ziyuanzuhe.route('/zizhu_ziyuanzuhe')
def getzizhu_ziyuanzuhe():
        try:
            ...
            resp_dict = Zizhu_Create_Order_ziyuanzuhe(url, params)
...
def Zizhu_Create_Order_ziyuanzuhe(url,params):
...
def Zizhu_GET_orderId(params):
    ...
    #print (Create_Order_ID_zizhu_ziyuanzuhe())
